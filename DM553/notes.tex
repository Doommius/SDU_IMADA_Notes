...
$ S \rightarrow BAB | B | \epsilon $
$ B \rightarrow 00 | \epsilon $

From here we can eliminate the first $\epsilon$

$ S \rightarrow BAB | B | \epsilon $
$ B \rightarrow 00 \sout{| \epsilon }$
...
The pumping lemma is a way for us to proof if a language is regular. en example would be the language.
$0^n1^n | n \geq 0$

The way you do this is to assume it's regular and make a counter argument. in this cases there are 3. the first case we can pump the language to have more 1's than 0s or(2) the other way around.. the third(3) is that we can get out of order letters if we pump a string containing both 0s and 1s, 

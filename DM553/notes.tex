...
\hline
Comparison & \multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}}x\_1\\ Status Value\end{tabular}} & \multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}}x\_2\\ Status Value\end{tabular}} & \multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}}x\_3\\ Status Value\end{tabular}} & \multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}}x\_4\\ Status Value\end{tabular}} & \multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}}x\_5\\ Status Value\end{tabular}} & \multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}}x\_6\\ Status Value\end{tabular}} & \multicolumn{1}{c}{\begin{tabular}[c]{@{}c@{}}Info\\ Given\end{tabular}} \\ \hline
...
\begin{tabular}{lccc}
\hline
\begin{tabular}[c]{@{}l@{}}Status of keys x and y\\ Compared by an algorithm\end{tabular} & \multicolumn{1}{l}{Adversary argument} & \multicolumn{1}{l}{New status} & \multicolumn{1}{l}{Units of new information} \\ \hline
N,N                                                                                       & x\textgreater{}y                       & W,L                            & 2                                            \\
W,N or WL, N                                                                              & x\textgreater{}y                       & W,L or WL, L                   & 1                                            \\
L,N                                                                                       & x \textless{}y                         & L,W                            & 1                                            \\
W,W                                                                                       & x \textgreater y                       & W, WL                          & 1                                            \\
L,L                                                                                       & x\textgreater{}y                       & WL,W                           & 1                                            \\
W,L, or WL,L og W, WL                                                                     & x\textgreater{}y                       & no change                      & 0                                            \\
...
\end{tikzpicture}\\
\caption{\textbf{Figure 3,1} An example of a tournament, max = L[6] secondlargest may be L[4],L[5], or L[7]}
\end{figure}
...
\vspace{5mm}
Out adversary was not as clever as it could have been in it's attempt to force an algorithm to do noncucial comparisons, in the past several years the lower found for the median problem has crept up the roughly 1.75n-log n, then roughly 1.8n then a little higher. the best lower bound currently known is slightly above 2n for large n, there is still a small gap between the best known and the lower bound and the best known algorithm for finding the median.

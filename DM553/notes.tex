...
\section{Regular languages Closure under}
TODO
...
A pushdown automata is a type of automaton that employs a stack to help with the computation, this allows the PDA to recognize and run Context free grammars and all the languages below it(Regular languages).

\begin{itemize}
\item The set of states Q, 
\item The known alphabet $\Sigma$, 
\item $\Gamma $ the stack alphabet
\item The transition function $\delta: Q \times \Sigma_\epsilon \times \Gamma_\epsilon\longrightarrow Q$
...
\section{example/proof - Turing recognizable/decidable}
